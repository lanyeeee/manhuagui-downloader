    ...
    <n-dialog :showIcon="false" @close="showing = false">
      <div class="flex flex-col items-center gap-row-6">
        ...
        <div class="text-center text-gray-400 text-xs">
          <div>
            如果本项目对你有帮助，欢迎来
            <n-a href="https://github.com/lanyeeee/manhuagui-downloader" target="_blank">GitHub</n-a>
            点个Star⭐支持！
          </div>
        ...
        <div class="flex flex-col w-full gap-row-3 px-6">
          ...
          <div class="flex items-center justify-between py-2 px-4 bg-gray-100 rounded-lg">
            ...
            <n-a href="https://github.com/lanyeeee/manhuagui-downloader/issues" target="_blank">GitHub Issues</n-a>
          </div>
        </div>
        <div class="flex flex-col text-xs items-center text-gray-400">
          ...
          <div>
            Released under
            <n-a href="https://github.com/lanyeeee/manhuagui-downloader/blob/main/LICENSE" target="_blank">
              MIT License
            </n-a>
          </div>
        </div>
